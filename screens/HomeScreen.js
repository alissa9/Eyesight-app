...
const HomeScreen = () => {
  ...
  return (
    <SafeAreaView style={tw("flex-1 ")}>
      ...
      <View style={tw("flex-row items-center justify-between px-5")}>
        <TouchableOpacity onPress={() => navigation.navigate("Profile")}>
          <Image
            ...
            style={tw("h-16 w-16 rounded-full mt-2")}
          />
        </TouchableOpacity>
        <TouchableOpacity>
          <Image
            style={tw("h-20 w-20 bg-transparent")}
      ...
      <View
        style={tw(
          "flex-row items-center justify-between px-5 absolute inset-x-12 bottom-0 h-40 mb-2 "
        )}
      >
        <TouchableOpacity
          style={tw(" bg-red-300  ")}
